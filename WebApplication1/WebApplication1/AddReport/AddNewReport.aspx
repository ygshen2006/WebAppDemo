...
<html xmlns="http://www.w3.org/1999/xhtml" style="background:url(../Images/index.gif) repeat fixed left top transparent">
<head runat="server">
    <style type="text/css">
            .user-name-link {
            color:white;
        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="head" style="margin-bottom:-80px">
                    <ul id="report-list">
                        <li>文章标题:*<input type="text" class="articleClass" />
                            </li>
                        <li>文章类型:* <select id="articleType" class="articleClass"></select></li>
                        <li>文章标签：
                             <ul id="articleTags" class="articleClass">

                             </ul>
                        </li>
                        <li>所属团队 :
                            <select id="teamBelong" class="articleClass"></select>
                        </li>
                        <li>
                            状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态: <select class="articleClass" id="articleStatus">
                ...
                <div class="head">
                     ...
                     <textarea id="editor1" name="editor1" rows="10" cols="80" runat="server" style="width:100%"></textarea>

                    <div class="actionArea">
                        <input type="button" id="test1" value="提交" title="" class="resetBt2" style="margin:3px" />
