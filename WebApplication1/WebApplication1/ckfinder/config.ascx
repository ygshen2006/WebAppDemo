...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        if (Session["IsAuthorized"] != null && (bool)Session["IsAuthorized"] == true)
        {
            ...
            string ImagePath = serverRoot + "/CustomerPicture/Images/" + Session["UserName"];
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = "../../../../CustomerPicture/Images/" + Session["UserName"] + "/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        //BaseDir = @"C:\SelfCode\rest\Web\WebApplication1\WebApplication1\ckfinder\userfiles\" + Session["UserName"] + @"\";
        BaseDir = "";
		...
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "swf", "flv", "mp4", "wmv" };
		type.DeniedExtensions = new string[] { };
